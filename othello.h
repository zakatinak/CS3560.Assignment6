///This is the Othello .h file. 
///The purpose of this file is to create the function headers that create the rules of the game, the possible moves, and construct the board.
